...
onMounted(() => {
	getIframeListRoutes();
	// https://gitee.com/lyt-top/ fast-cloud-ui/issues/I58U75
	// https://gitee.com/lyt-top/ fast-cloud-ui/issues/I59RXK
	// https://gitee.com/lyt-top/ fast-cloud-ui/pulls/40
	nextTick(() => {
		setTimeout(() => {
...
// https://toscode.gitee.com/lyt-top/ fast-cloud-ui/pulls/38/files
watch(
	() => route.fullPath,
	() => {

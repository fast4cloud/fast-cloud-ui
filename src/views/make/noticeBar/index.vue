	...
	<div class="notice-bar-container layout-pd">
		<el-card shadow="hover" header="滚动通知栏：默认">
			<NoticeBar
				...
				的后台开源免费模板库（vue2.x请切换vue-prev-admin分支），仓库地址：https://gitee.com/lyt-top/ fast-cloud-ui"
			/>
		</el-card>
...
const state = reactive({
	noticeList: [
		...
		'仓库地址：https://gitee.com/lyt-top/ fast-cloud-ui',
		'演示地址：https://lyt-top.gitee.io/ fast-cloud-ui-preview/#/login',
	],
	tableData: [
		{
			a1: 'mode',

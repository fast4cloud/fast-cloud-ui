      ...
      <div class="system-user-search mb15">
        <el-form :model="state.tableData.param.data" size="small" :inline="true">
          <el-form-item size="default" label="公告标题" prop="noticeTitle">
            <el-input v-model="state.tableData.param.data.noticeTitle" size="default" placeholder="请输入公告标题" style="max-width: 180px"></el-input>
          </el-form-item>
          <el-form-item>
...
const getTableData = async () => {
  ...
  if (typeof (id) != "undefined") {
    state.tableData.param.data.id = id
  }

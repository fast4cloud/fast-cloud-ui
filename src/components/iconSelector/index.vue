...
const initFontIconName = () => {
	let name = 'ali';
	if (typeof (props.modelValue)!='undefined'&&props.modelValue!.indexOf('iconfont') > -1) name = 'ali';
	else if (typeof (props.modelValue)!='undefined'&&props.modelValue!.indexOf('ele-') > -1) name = 'ele';
	else if (typeof (props.modelValue)!='undefined'&&props.modelValue!.indexOf('fa') > -1) name = 'awe';
	// 初始化 tab 高亮回显
